 ...
 * It is run as a eas-build-pre-install script in the `package.json` of expo app.
 * It is executed as `node tools/scripts/nx-eas-build-pre-install.mjs <workspace root> <project root>`
